...
<head>
    ...
    <link rel="stylesheet" href="../css/admin-pesan-masuk.css">
</head>
<body>
    <div class="container">
        <!-- Sidebar -->
        ...
        <main class="main-content">
            ...
            <div class="content-grid">
                <?php $pesan_masuk = get_all_pesan_masuk($_SESSION['user']['ID_User']);
                    if (mysqli_num_rows($pesan_masuk) > 0) {
                        while ($pesan = mysqli_fetch_assoc($pesan_masuk)) {
                            $data_pesan = $pesan['Judul_Pesan_Masuk'];
                            echo "<div class='column-grid'>";
                            echo "<h2>$data_pesan</h2>";
                            echo "<img src='../assets/img/delete.png' alt='delete-icon' class='icon-delete'>";
                            echo "</div>";   
                            
                        }
                    }else{
                            echo "<div class='column-grid'>";
                            echo "<h2>Belum ada pesan masuk</h2>";
                            echo "</div>";
                    }?>
