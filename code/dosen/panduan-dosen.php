    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <div class="description">
                <h3>Panduan Dosen ▷</h3>
                <p>
                    <a href="../data/Panduan-Penelitian.pdf" download> 
                        Lihat Panduan Penelitian
                    </a>
                    <a href="../data/Lampiran-Peruturan-MBKM-UTM.pdf" download> 
                        Lihat Panduan MBKM
                    </a>
                    <a href="../data/Lampiran-Peruturan-MBKM-UTM.pdf" download> 
                        Lihat Panduan Perwalian
                    </a>
                    <a href="../data/Lampiran-Peruturan-MBKM-UTM.pdf" download> 
                        Lihat Panduan Pengisian Nilai
                    </a>
                </p>
            </div>
        </main>
...
<script src="../js/panduan-dosen.js"></script>
</body>
</html>